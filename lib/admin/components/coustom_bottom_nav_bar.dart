            ...
            children: [
              IconButton(
                icon: SvgPicture.asset(
                  ...
                  color: MenuState.adminhome == selectedMenu
                      ? kPrimaryColor
                      : inActiveIconColor,
                ),
                onPressed: () =>
                    Navigator.pushNamed(context, AdminHomeScreen.routeName),
                    //user or admin حددي لما تبرمجي
              ),
              // IconButton(
              ...
              IconButton(
                ...
                color: MenuState.userorders == selectedMenu
                      ? kPrimaryColor
                      : inActiveIconColor,),
                onPressed: () =>
                    Navigator.pushNamed(context, UserOrdersScreen.routeName),
              ),
              IconButton(
                icon: SvgPicture.asset(
                  "assets/icons/User Icon.svg",
                  color: MenuState.adminprofile == selectedMenu
                      ? kPrimaryColor
                      : inActiveIconColor,
                ),
                onPressed: ()  =>
