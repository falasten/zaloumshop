...
class PopularProducts extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Provider.of<ProductProvider>(context, listen: false).catProduct();
    return Consumer<ProductProvider>(builder: (context, value, child) {
      List<Product> allProducts = value.allSaerchProducts;
      List<Product> allCatProducts = value.allCatProducts;
      String catValue = value.catValue;
        ...
        if (catValue == "All") {
          ...
          return Expanded(
            child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  return ProductCard(product: allCatProducts[index]);
                }),
          );
        }
      } else {
