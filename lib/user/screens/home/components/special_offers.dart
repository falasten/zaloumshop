...
import 'package:zaloum_for_shopping/user/components/special_card.dart';
...
class SpecialOffers extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<AdminOrderProvider>(builder: (context, value, child) {
      List<AdminOrder> specialOrdersList = value.specialOrders; 
        if(specialOrdersList.isEmpty){
          return Center(
